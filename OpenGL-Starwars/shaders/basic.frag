...
{
    // Direction - Convert lightDir to Eye Space
...
{
    // Position & Direction - Convert Point Light Position to Eye Space
    ...
    // Attenuation (How fast light fades)
    float constant = 1.0f;
...
void main() 
{
    ...
    // transparency check for textures
    if(texColor.x == 0)
        discard;
